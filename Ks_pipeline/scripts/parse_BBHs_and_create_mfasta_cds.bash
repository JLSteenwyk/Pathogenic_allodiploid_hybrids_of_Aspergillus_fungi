...
do
	...
	do
		A_gene=$(echo "$line")
		B_gene=$(echo "$column")
		samtools faidx $A_cds_fasta $A_gene >> ./FILES_BBH_mfastas_cds/$A_gene.mfasta
		samtools faidx $B_cds_fasta $B_gene >> ./FILES_BBH_mfastas_cds/$A_gene.mfasta
	done
	echo "..."
done < /dev/stdin
